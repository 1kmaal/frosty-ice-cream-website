...
import { motion, AnimatePresence, type TargetAndTransition, type VariantLabels } from "framer-motion";
  ...
  (props, ref) => {
    ...
    const splitIntoCharacters = (text: string) => {
      if (typeof IntlWithSegmenter !== "undefined" && IntlWithSegmenter.Segmenter) {
        ...
        return Array.from(
          segmenter.segment(text) as Array<{ segment: string }>,
    ...
    return (
      ...
      >
        ...
        <AnimatePresence
          mode={animatePresenceMode as "wait" | "sync" | "popLayout"}
